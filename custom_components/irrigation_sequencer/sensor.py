...
from .const import (
    ...
    ATTR_SCALED_TOTAL_SECONDS,
    ATTR_WEATHER_EFFECTIVE_TEMP,
    ATTR_WEATHER_FORECAST_HIGH,
    ATTR_WEATHER_REFERENCE_TEMP,
    ATTR_WEATHER_TEMP_SOURCE,
    ATTR_WINTER_MODE,
    ATTR_ZONES,
    DOMAIN,
)
...
class IrrigationSequencerStatusSensor(Entity):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            ATTR_NOTIFY_TARGET: self._manager.notify_target,
            ...
            ATTR_ESTIMATED_TOTAL_SECONDS: self._manager.estimated_total_seconds,
            ...
            ATTR_WEATHER_TEMP_SOURCE: self._manager.weather_temp_source,
            ...
            ATTR_LAST_ZONE_SAFETY_SWEEP: self._manager.last_zone_safety_sweep,
        }
